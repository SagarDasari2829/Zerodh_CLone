...
import './index.css'
import Hero from './about/Heros';
function Footer() {
    return ( 
<div className='container mt-5 back'>
    <div className='row  mt-5'>
        <div className='col-4'>
             <img src="media/images/logo.svg"  style={{width:"35%",  marginLeft:"5rem", marginTop:"2rem"}}/>
             <p className='mt-3' style={{width:"20vw", marginLeft:"5rem"}}>© 2010 - 2025, Zerodha Broking Ltd.
...
All rights reserved.</p>
        ...
        <div className='col-2'>
            <p className='fs-5' style={{color:"black"}}>Company</p>
            <div className='company'>
             ...
             <a href=''>Zerodha Cares (CSR)</a> 
              <a href=''>Zerodha.tech Open</a> 
              <a href=''> Open source</a>
              </div>
              
        </div>
        <div className='col-2'>
            <p className='fs-5' style={{color:"black"}}>Support</p>
            <div className='company'>
               <a href=''> Contact us</a>
       ...
       <div className='col-2'>
            <p className='fs-5' style={{color:"black"}}>Account</p>
         ...
         <div className='col-2'>
            <p className='fs-5' style={{color:"black"}}>Quick links</p>
            <div className='company mb-5' >
   ...
   <p className='para '>
    nvestments in securities market are subject to market risks; read all the related documents carefully before investing.
   </p>
